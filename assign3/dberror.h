...
#define RC_NO_FILENAME 5
#define RC_FILE_CREATION_FAILED 6
#define RC_FILE_NOT_INITIALIZED 7
#define RC_FILE_NOT_CLOSED 8
...
#define RC_RM_INIT_ERROR 206
#define RC_RM_NO_FREE_PAGES 207
#define RC_RM_FILE_ALREADY_EXISTS 208
